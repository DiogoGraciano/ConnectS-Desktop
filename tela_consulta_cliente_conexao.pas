unit tela_consulta_cliente_conexao;
...
type
  Tform_consulta_cliente_conexao = class(TForm)
    Panel1: TPanel;
...
var
  form_consulta_cliente_conexao: Tform_consulta_cliente_conexao;

implementation

{$R *.dfm}

uses tela_conexao, tela_login;

procedure Tform_consulta_cliente_conexao.btn_pesquisaClick(Sender: TObject);
begin
...
procedure Tform_consulta_cliente_conexao.btn_retornarClick(Sender: TObject);
begin
  close;
  form_conexao.txt_box_pesquisa.Text := grid_consulta_cliente.columns.items[0].field.text;
end;

procedure Tform_consulta_cliente_conexao.FormCreate(Sender: TObject);
begin
...
procedure Tform_consulta_cliente_conexao.FormKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure Tform_consulta_cliente_conexao.FormShow(Sender: TObject);
begin
    FDQuery_consulta_cliente.close;
    FDQuery_consulta_cliente.SQL.Clear;
    FDQuery_consulta_cliente.SQL.Add('select cd_cliente, nr_loja, nm_cliente from cadastro.tb_cliente');
...
procedure Tform_consulta_cliente_conexao.grid_consulta_clienteCellClick(
  Column: TColumn);
begin
  close;
  form_conexao.txt_box_pesquisa.Text := grid_consulta_cliente.columns.items[0].field.text;;
...
procedure Tform_consulta_cliente_conexao.grid_consulta_clienteTitleClick(
  Column: TColumn);
var
i : integer;
begin
