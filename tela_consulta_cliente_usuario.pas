unit tela_consulta_cliente_usuario;
...
type
  Tform_consulta_cliente_usuario = class(TForm)
    Panel1: TPanel;
...
var
  form_consulta_cliente_usuario: Tform_consulta_cliente_usuario;

implementation

{$R *.dfm}

uses tela_conexao, tela_cadastro_usuario, tela_login;

procedure Tform_consulta_cliente_usuario.btn_pesquisaClick(Sender: TObject);
begin
...
procedure Tform_consulta_cliente_usuario.btn_retornarClick(Sender: TObject);
begin
    close;
    form_cadastro_usuario.txt_box_cd_cliente.Text := grid_consulta_cliente.columns.items[0].field.text;
end;

procedure Tform_consulta_cliente_usuario.FormCreate(Sender: TObject);
begin
...
procedure Tform_consulta_cliente_usuario.FormKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure Tform_consulta_cliente_usuario.FormShow(Sender: TObject);
begin
    FDQuery_consulta_cliente.close;
    FDQuery_consulta_cliente.SQL.Clear;
    FDQuery_consulta_cliente.SQL.Add('select cd_cliente, nr_loja, nm_cliente from cadastro.tb_cliente');
...
procedure Tform_consulta_cliente_usuario.grid_consulta_clienteCellClick(
  Column: TColumn);
begin
    close;
    form_cadastro_usuario.txt_box_cd_cliente.Text := grid_consulta_cliente.columns.items[0].field.text;
...
procedure Tform_consulta_cliente_usuario.grid_consulta_clienteTitleClick(
  Column: TColumn);
var
i : integer;
begin
